...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "tgbot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "tgbot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/We_xbot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/We_xbot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "<b>- تم الاستخـراج بواسطـة ☕️  @X_77_P</b>")
    ...
    ORIGINAL_CODE = "aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL21yaXNtYW5heml6L1NjcmFwLU1hbi9tYXN0ZXIvYm90LnB5"
